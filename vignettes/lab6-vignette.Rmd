...
The computation time needed for 16 objects with parallel computation is 0.5 seconds resulting in a performance gain of 12.5 seconds.
```{r}
st <- system.time(bfk <- brute_force_knapsack(x = knapsack_objects[1:16,], W = 2000, parallel=TRUE))
print(paste0("time needed: ", toString(round(as.numeric(st)[1], 2)), "s"))
```
